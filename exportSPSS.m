...
%
%   exportSPSS(ALLEEGDATA, exportTimeWin, timeVector, chanLabels, feature, saveTableSPSSPath)
...
%       exportSPSS(ALLEEGDATA, [100 200], EEG.times, {EEG.chanlocs.labels}, ["Latency", "Peak Amplitude"]);
%
%   Author: Dino Soldic
...
function exportSPSS(ALLEEGDATA, exportTimeWin, timeVector, chanLabels, feature, saveTableSPSSPath)
    ...
    % Initialize vars
    featuresToCheck = ["Latency", "Average Amplitude", "Peak Amplitude"];
    groupDisplacement = 0;
